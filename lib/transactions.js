...
exports.createGeneration = function(rpcData, blockReward, charityReward, feeReward, recipients, poolAddress, charityRewardStartBlockHeight, charityAddress){
    var poolAddrHash = bitcoin.address.fromBase58Check(poolAddress).hash;
    var charityAddrhash = bitcoin.address.fromBase58Check(charityAddress).hash;  
  ...
  if (blockHeight >= charityRewardStartBlockHeight)
  {
    tx.addOutput(
