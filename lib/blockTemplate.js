...
**/
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, extraNoncePlaceholder, reward, recipients, poolAddress, charityRewardStartBlockHeight, charityAddress){
    ...
    if(this.rpcData.height >=charityRewardStartBlockHeight )
    {
        charityReward = this.rpcData.charityvalue;
    }
    ...
    if (typeof this.genTx === 'undefined') {
        this.genTx = transactions.createGeneration(rpcData, blockReward, charityReward, this.rewardFees, recipients, poolAddress, charityRewardStartBlockHeight, charityAddress).toString('hex');
